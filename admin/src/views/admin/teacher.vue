...
<!--    </table>-->
    ...
    <div class="row">
      <div v-for="teacher in teachers" class="col-md-3 left">
        <div>
          <span class="profile-picture">
            <img v-show="!teacher.image" class="editable img-responsive editable-click editable-empty" src="/static/image/讲师头像/讲师头像4.jpg" v-bind:title="teacher.intro"/>
